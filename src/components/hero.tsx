...
export const Hero = () => {
  return (
    <div className="mt-40 flex flex-col items-center justify-center w-full">
        <h1 className="max-w-4xl bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-500 text-center text-7xl leading-tight font-bold text-transparent">Unleash the power of intuitive finance</h1>
